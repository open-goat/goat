...
# 创建protobuf文件目录
$ make -pv /usr/local/include/github.com/open-goat/goat/pb

# 找到最新的goat protobuf文件
$ ls `go env GOPATH`/pkg/mod/github.com/open-goat/

# 复制到/usr/local/include
$ cp -rf pb  /usr/local/include/github.com/open-goat/goat/pb
```
