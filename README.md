# goat
![Build and Test](https://github.com/open-goat/goat/workflows/Build%20and%20Test/badge.svg)
[![codecov](https://codecov.io/gh/open-goat/goat/branch/master/graph/badge.svg)](https://codecov.io/gh/open-goat/goat)
[![Go Report Card](https://goreportcard.com/badge/github.com/open-goat/goat)](https://goreportcard.com/report/github.com/open-goat/goat)
[![Release](https://img.shields.io/github/release/open-goat/goat.svg?style=flat-square)](https://github.com/open-goat/goat/releases)
[![MIT License](https://img.shields.io/github/license/open-goat/goat.svg)](https://github.com/open-goat/goat/blob/master/LICENSE)
...
```sh
$ go install github.com/open-goat/goat/cmd/goat 
```
...
$ mkdir demo && cd demo
$ goat init
? 请输入项目包名称: github.com/open-goat/demo
...
基于上面的样例生成如下:
```
// Code generated by github.com/open-goat/goat
// DO NOT EDIT
